        ...
        try {
            ...
            $('.input-container').each(function(index) {
                ...
                if (qTyppe == 'radio' || qTyppe == 'checkbox' || qTyppe == 'select') {
                    ...
                    if (qTyppe == 'select') {
                        // optionValueContainer[$('#' + datablock + ' .client-input-field .select-input-ans').val()] = $('#' + datablock + ' .client-input-field .select-input-ans').html();
                        optionValueContainer[$('#' + datablock + ' .client-input-field .select-input-ans').val()] = $('#' + datablock + ' .client-input-field .select-input-ans').val();
                    } else {
