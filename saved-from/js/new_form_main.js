...
// Add  Options -------------
function callbackAddOption(option_id, currentIndex, preOptionId, o_type) {
    // console.log('option_id:' + option_id + ' Block Id:' + currentIndex);
    // var currentIndex = getCurrentIndex();
    $('#' + preOptionId).attr('id', option_id + '_option');
    // if (o_type == 'add') {
    //     var countOption = $('#' + currentIndex + ' .client-input-field').children().length;
    //     var preType = $('#' + currentIndex + ' .client-input-field input:first-child').attr('type');
...
// Add Option function
function addNewOption(blockid, preOptionId, o_type) {
    // var question_no;
    jQuery.ajax({
        type: "POST",
        url: "ajax/update_form.php",
        ...
        success: function(result) {
            ...
            callbackAddOption(reponse["ID"], blockid, preOptionId, o_type);
        },
        error: function(errorData) {
            console.log(errorData);
        }
